...
public class CustomTimePickerDialog extends DialogFragment implements
    ...
    protected boolean isAutoDismissOnOk;
    ...
    public interface OnTimeSetListener {
         ...
         */
        void onTimeSet(CustomTimePickerDialog view, int hourOfDay, int minute, int second);
    }
    ...
    public static CustomTimePickerDialog newInstance(OnTimeSetListener callback,
                                               int hourOfDay, int minute, int second, boolean is24HourMode) {
        CustomTimePickerDialog ret = new CustomTimePickerDialog();
    ...
    public static CustomTimePickerDialog newInstance(OnTimeSetListener callback,
        ...
        return CustomTimePickerDialog.newInstance(callback, hourOfDay, minute, 0, is24HourMode);
    }
    ...
    public void setAutoDismissOnOk(boolean autoDismissOnOk) {
        isAutoDismissOnOk = autoDismissOnOk;
    }

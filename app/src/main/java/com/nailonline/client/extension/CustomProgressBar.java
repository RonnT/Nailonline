...
public class CustomProgressBar extends ProgressBar {
    ...
    private static final String THIRD_PROGRESS = "thirdProgress";
    ...
    public CustomProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            secondaryProgressColour = ta.getColor(R.styleable.MaterialProgressBar_secondProgressColour, 0);
